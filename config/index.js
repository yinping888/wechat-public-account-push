export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx5ff086becc95626b",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "3cf5b6ed1737e06efce2134bbf991d42",
  ...
  USERS: [
    {
      ...
      id: "6hQbcL8JbmYzVnwD51xGx94LzjuO6-CoYcdjvBKq6kQ",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "",
      // 所在省份
      province: "成都",
  ...
  CALLBACK_TEMPLATE_ID: "6hQbcL8JbmYzVnwD51xGx94LzjuO6-CoYcdjvBKq6kQ",
  ...
  CALLBACK_USERS: [
    {
      ...
      id: "ocxKa5qPW7wO8fqJAwCxzPjiikwU",
    },
    // 你可以不断按格式往下增加
    // ...
  ],
